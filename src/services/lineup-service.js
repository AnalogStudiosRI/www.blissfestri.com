...
const LINEUP = [{
  ...
  isOpener: true,
  name: 'Nate Farrar',
  bio: 'As a long time player and supporter of the Newport arts and music scene, Nate Farrar joins our stage will all original, RI inspired Americana Folk.  With Mikel Arambarri joining him on lap steel, for a rare duo performance, we\'re in for a real treat on this one!',
