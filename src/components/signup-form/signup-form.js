export default class SignupForm extends HTMLElement {
  connectedCallback() {
    this.innerHTML = `
      <div
        id="signup-form"
        class="bg-primary p-1 text-center m-4"
      >
        <img
          ...
          loading="lazy"
        />
        <div class="md:w-3/5 xl:w-2/5 mr-auto ml-auto">
          <h2
          ...
          >
            ...
            <button
              type="submit"
              class="bg-secondary p-2 rounded-3xl text-primary font-bold m-auto mt-4 font-primary"
            >
              Sign Me Up
            </button>
          </form>
